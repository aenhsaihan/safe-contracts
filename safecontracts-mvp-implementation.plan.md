...
- Create S3 bucket resource in `amplify/storage/resource.ts` with versioning enabled
...
- [ ] Initialize Amplify Gen 2, create S3 bucket and KMS CMK resources with proper IAM permissions
